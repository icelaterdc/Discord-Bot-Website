  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       How about moderating your own server with Slayer Bot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/oauth2/authorize?client_id=1201613667561639947&scope=bot%20applications.commands&permissions=8"}>
              <a
                className={
