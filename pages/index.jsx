    ...
    <>
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
          ...
          <Link href={"https://top.gg/bot/1201613667561639947/vote"}>
            <a 
              ...
              onClick={(e) => isDisabled && e.preventDefault()}
            >
              <ButtonContent>Botu Oyla</ButtonContent>
            </a>
          </Link>
        </div>
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
        <>
          ...
          <img src="https://media.discordapp.net/attachments/907378577253744640/1176892776877666325/image.png" clas
sName="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
        </>
      </div>
    </>
  )
